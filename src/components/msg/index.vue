 ...
 <div class="weui-msg">
    ...
    <div class="weui-msg__opr-area">
      <p class="weui-btn-area">
        ...
        <a v-for="button in buttons" href="javascript:;" class="weui-btn"  :class="[`weui-btn_${button.type}`,`weui-btn_circle-${button.type}`]" @click="onClick(button.onClick, button.link)">{{button.text}}</a>
      </p>
    </div>
  </div>
</template>
