<template>
  <div class="weui-tab">
    ...
    <div class="weui-tab__panel m-fix-safari-overflow-scrolling" ref="viewBoxBody" id="m_view_box_body" :style='{paddingTop: bodyPaddingTop, paddingBottom: bodyPaddingBottom}'>
      <slot></slot>
    </div>
