<template>
  <div>
    ...
    <group title="disabled = true">
      ...
      <cell title="custom font-size(0.5rem)">
        <rater v-model="data42" slot="value" active-color="#04BE02" :font-size="0.5" disabled></rater>
      </cell>
    </group>

    <group title="custom star, some symbols like ♥ ❤ are not proper.">
      <cell title="loving">
        <rater v-model="data4" slot="value" star="♡" active-color="red" :margin="0.15"></rater>
      </cell>
      <cell title="Sunshine">
        <rater v-model="data5" slot="value" star="◆" active-color="#FF9900" :margin="0.2"></rater>
      </cell>
      <cell title="Smilies">
        <rater v-model="data5" slot="value" star="☻" active-color="#FF9900" :margin="0.2"></rater>
      </cell>
      ...
      <cell title="How embarrass">
        <rater v-model="data5" slot="value" star="囧" active-color="#FF9900" :margin="0.2"></rater>
      </cell>
    </group>
