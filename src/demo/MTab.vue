  ...
  <div>
    ...
    <div>
      <tab :line-width=2 active-color='#fc378c' v-model="index">
        <tab-item class="m-center" :selected="demo2 === item" v-for="(item, index) in list2" @click="demo2 = item" :key="index">{{item}}</tab-item>
      </tab>
      <swiper v-model="index" height="100px" :show-dots="false">
        <swiper-item v-for="(item, index) in list2" :key="index">
          <div class="tab-swiper m-center">{{item}} Container</div>
        </swiper-item>
      </swiper>
    </div>
    ...
    <br/>
    <tab :line-width="2">
      <tab-item :selected="demo3 === item" v-for="(item, index) in list3" :class="{'m-1px-r': index===0}" @click="demo3 = item" :key="index">{{item}}</tab-item>
    </tab>
    <br/>
    <br/>
    <br/>
    <sticky scrollBox="app" :check-sticky-support="true" :offset="0">
      <tab :line-width=1>
