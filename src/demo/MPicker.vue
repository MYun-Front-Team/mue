<template>
  <div>
    ...
    <m-button type="primary" @click.native="changeValue([['1','3','5','7','9','11'],['2','3','4','5'],['a','b','c']])">Set Data1</m-button>
    <m-button type="primary" @click.native="changeValue([['1','3','5','7','9','11'],['2','3','4','5']])">Set Data1</m-button>
    <m-button type="primary" @click.native="changeValue([['2','4','6','8','10','11']])">Set Data2</m-button>
    <br>
    ...
    <m-button @click.native="setData1" type="primary">set Value to ["USA", "usa002", "0005"]</m-button>
    <m-button @click.native="setData2" type="primary">set Value to ["china", "china002", "gz"]</m-button>
