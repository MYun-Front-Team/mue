<template>
  <div>
    <checklist title="Basic Usage" required :options="commonList" v-model="checklist001" @on-change="change"></checklist>
    ...
    <checklist title="preselect China and Japan" :options="commonList" v-model="checklist002" @on-change="change"></checklist>
